...
function storeData(){
    ...
    div.innerHTML = `<div><span class="count">${count}. </span><span>${input.value}</span> </div> <div class="data">${inputDate.value}</div> <div><span class="priority"><span>Priority: </span>${priority.value}</span></div> <div class="last"> <span class="mark"><i class="fa-regular fa-square-check"></i></span> <span class="delete"><i class="fa-solid fa-trash"></i></span>  </div>`
